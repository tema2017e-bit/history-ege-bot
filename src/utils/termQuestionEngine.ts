...
function generateTermScenario(cardMeta: TermMeta, eraTerms: TermMeta[], historyCards: HistoryCard[]): Question | null {
  ...
  const scenarios: Record<string, string> = {
    ...
    'Уроки': 'После гибели князя Игоря при повторном сборе дани княгиня Ольга установила точный размер поборов для каждой земли.',
    'Погосты': 'Княгиня Ольга создала специальные административные центры, куда жители должны были свозить дань, а не ждать объезда князя.',
